...
class BlitOverlay:
    ...
    def execute(self):
        if self.pos == (620, 620):
            func = LoadImage("icons/backgrounds/table.png", (140, 160))
            ...
            func = LoadImage("icons/backgrounds/table.png", (160, 140))
            overlay = func.execute()
            ...
            func = LoadImage("icons/backgrounds/table.png", (110, 160))
            overlay = func.execute()
